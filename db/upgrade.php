...
function xmldb_qtype_recordrtc_upgrade(int $oldversion): bool {
    ...
    if ($oldversion < 2020012100) {
        ...
        $field = new xmldb_field('enablereflection', XMLDB_TYPE_INTEGER, '2', null, XMLDB_NOTNULL, null, '0', 'canselfcomment');
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
        }

        $field = new xmldb_field('reflectiontime', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, '10', 'enablereflection');
