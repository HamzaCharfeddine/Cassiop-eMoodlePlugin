...
$string['showquestion_desc'] = 'Reveal the full question after clicking the button and reflecting for a set time.';
$string['reflectiontime'] = 'Reflection Time';
$string['reflectiontime_desc'] = 'Set the number of seconds students have to reflect before recording starts.';
$string['reflectiontime_desc_help'] = 'Define how long students should have to think about their response before recording begins.';
$string['reflectiontime_remaining'] = 'Reflection time remaining: {$a} seconds';
...
$string['reflectionandpreviewtime'] = 'Reflection and preview time';
$string['previewingquestion'] = 'Previewing question: {$a} seconds remaining';
$string['finishrecording'] = 'Finish and next';
$string['errorinreflectiontime'] = 'Reflection and preview time must be a positive number';
$string['reflectioninstructions'] = 'After recording, you will have time to reflect on your response.';
$string['mediatype'] = 'Media type';
$string['audio'] = 'Audio';
$string['video'] = 'Video';
$string['screen'] = 'Screen';
$string['customav'] = 'Custom audio/video';
$string['timelimit'] = 'Recording time limit';
$string['errorintimelimit'] = 'Time limit must be a positive number';
$string['timelimittoohigh'] = 'Time limit cannot exceed {$a} seconds';
$string['allowpausing'] = 'Allow pausing';
$string['canselfrate'] = 'Allow self-rating';
$string['canselfcomment'] = 'Allow self-commenting';
$string['enablereflection'] = 'Enable reflection';
$string['reflectiontime'] = 'Reflection time';
$string['notenoughwidgetplaceholders'] = 'Custom AV questions must contain at least two widget placeholders (:audio, :video, or :screen).';
$string['pleasecompleteallrecordings'] = 'Please complete all recordings.';
$string['norecording'] = 'No recording';
$string['startrecordingx'] = 'Start recording {0}';
$string['startcamerax'] = 'Start camera {0}';
$string['startsharescreenx'] = 'Start screen sharing {0}';
$string['recordagainx'] = 'Record again {0}';
$string['stoprecording'] = 'Stop recording';
$string['pause'] = 'Pause';
$string['showquestion'] = 'Show question';
$string['reflectiontime_remaining'] = 'Reflection time remaining: {$a} seconds';
$string['downloadrecording'] = 'Download recording: {$a}';
$string['insecurewarningtitle'] = 'Insecure connection';
$string['insecurewarning'] = 'This question type requires a secure (HTTPS) connection to work.';
$string['nowebrtctitle'] = 'WebRTC not supported';
$string['nowebrtc'] = 'Your browser does not support WebRTC, which is required for this question type.';
$string['feedbackforwidget'] = 'Feedback for widget {0}';