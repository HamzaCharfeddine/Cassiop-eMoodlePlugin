...
class qtype_recordrtc extends question_type {
    ...
    public function extra_question_fields(): array {
        return ['qtype_recordrtc_options', 'mediatype', 'timelimitinseconds', 'allowpausing', 'canselfrate', 'canselfcomment', 'enablereflection',     // New field
        'reflectiontime'];
    }
    ...
    public function save_defaults_for_new_questions(stdClass $fromform): void {
        ...
        $this->set_default_value('enablereflection', $fromform->enablereflection);
        $this->set_default_value('reflectiontime', $fromform->reflectiontime);
    }
    ...
    public function save_question_options($fromform) {
        ...
        // Get the existing options record
        $options = $DB->get_record('qtype_recordrtc_options', ['questionid' => $fromform->id]);

        if ($options) {
            // Update existing record
            if (isset($fromform->enablereflection)) {
                $options->enablereflection = $fromform->enablereflection;
            }
            if (isset($fromform->reflectiontime)) {
                $options->reflectiontime = (int)$fromform->reflectiontime;
            }
    ...
    protected function initialise_question_instance(question_definition $question, $questiondata) {
        ...
        $question->enablereflection = $questiondata->options->enablereflection;
        $question->reflectiontime = $questiondata->options->reflectiontime;
