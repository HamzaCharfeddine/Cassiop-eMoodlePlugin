...
abstract class recorder_base implements renderable, templatable {
    ...
    /**
     * @var int Reflection time in seconds.
     */
     ...
     * @param moodle_url|null $recordingurl If re-displaying after a recording, this is the audio file.
    ...
    public function __construct(
        ...
        bool $allowpausing,
        ?moodle_url $recordingurl,
        bool $candownload,
        bool $enablereflection = false,
        int $reflectiontime = 10
    ) {
